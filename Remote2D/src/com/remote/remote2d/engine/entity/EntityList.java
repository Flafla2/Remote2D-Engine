...
public class EntityList {
	...
	/**
	 * A big list of all of the Entities that are available. When spawning an
	 * Entity into the world, you need to add it to the entity list if you
	 * expect it to get tick()ed or render()ed.
	 */
		...
		for (int i = 0; i < entityList.size(); i++) {
			try {
				...
				if (editor) {
					...
					Renderer.drawCrossRect(entityList.get(i).pos,
							entityList.get(i).dim, 0xffffff, 1.0f);
