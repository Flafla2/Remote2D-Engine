...
public class InsertableComponentList {
	...
	public void addInsertableComponent(String s, Class<?> e) {
		if (Component.class.isAssignableFrom(e))
			...
			throw new IllegalArgumentException("Class " + e.getSimpleName()
					+ " does not directly extend Component!");
	}

	public Component getComponentWithEntity(String s, Entity entity) {
		return Component.newInstanceWithEntity(insertableComponents.get(s),
				entity);
	}
	...
	public String getComponentID(Class<?> e) {
		Iterator<Entry<String, Class<?>>> iterator = insertableComponents
				.entrySet().iterator();
