...
public class Camera {
	...
	public void renderBefore(float interpolation) {
		Vector2 pos = Interpolator.linearInterpolate(oldPos, this.pos,
				interpolation).subtract(DisplayHandler.getDimensions());
	...
	public ColliderBox getMapRenderArea() {
		return pos.subtract(getDimensions().divide(new Vector2(2)))
				.getColliderWithDim(getDimensions());
	}
	...
	public Matrix4f getMatrix() {
		...
		Vector3f translate2 = new Vector3f(-pos.x + Gui.screenWidth() / 2,
				-pos.y + Gui.screenHeight() / 2, 0);
	...
	public Matrix4f getInverseMatrix() {
		...
		Vector3f translate2 = new Vector3f(pos.x - Gui.screenWidth() / 2, pos.y
				- Gui.screenHeight() / 2, 0);
